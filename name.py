...
country_code_to_name = {
    ...
    24: "Angola", 28: "Antigua and Barbuda", 31: "Azerbaijan", 32: "Argentina", 36: "Australia",
    ...
    180: "Democratic Republic of the Congo", 184: "Cook Islands", 188: "Costa Rica",
    ...
    233: "Estonia", 234: "Faroe Islands", 239: "South Georgia and the South Sandwich Islands",
    242: "Fiji", 246: "Finland", 250: "France", 258: "French Polynesia", 262: "Djibouti",
    266: "Gabon", 268: "Georgia", 270: "Gambia", 275: "Palestine", 276: "Germany",
    ...
    368: "Iraq", 372: "Ireland", 376: "Israel", 380: "Italy", 384: "Côte d'Ivoire",
    ...
    438: "Liechtenstein", 440: "Lithuania", 442: "Luxembourg", 446: "Macau",
    ...
    535: "Bonaire, Sint Eustatius and Saba", 540: "New Caledonia", 548: "Vanuatu",
    554: "New Zealand", 558: "Nicaragua", 562: "Niger", 566: "Nigeria", 570: "Niue",
    574: "Norfolk Island", 578: "Norway", 580: "Northern Mariana Islands",
    581: "United States Minor Outlying Islands", 583: "Micronesia", 584: "Marshall Islands",
    585: "Palau", 586: "Pakistan", 591: "Panama", 598: "Papua New Guinea", 600: "Paraguay",
    604: "Peru", 608: "Philippines", 612: "Pitcairn Islands", 616: "Poland", 620: "Portugal",
    624: "Guinea-Bissau", 626: "East Timor", 630: "Puerto Rico", 634: "Qatar", 638: "Réunion",
    ...
    690: "Seychelles", 694: "Sierra Leone", 702: "Singapore", 703: "Slovakia", 704: "Vietnam",
    ...
    744: "Svalbard and Jan Mayen", 748: "Eswatini", 752: "Sweden", 756: "Switzerland",
    ...
    831: "Guernsey", 832: "Jersey", 833: "Isle of Man", 834: "Tanzania", 840: "United States",
    850: "U.S. Virgin Islands", 854: "Burkina Faso", 858: "Uruguay", 860: "Uzbekistan",
    862: "Venezuela", 876: "Wallis and Futuna", 882: "Samoa", 887: "Yemen", 894: "Zambia"
}

# Input and output file names
input_file = 'data/internet_usage.csv'
output_file = 'data/internet_usage_with_names.csv'

# Read the input CSV and write to the output CSV with the new column
with open(input_file, 'r') as infile, open(output_file, 'w', newline='') as outfile:
    ...
    header = next(reader)
    header.insert(1, 'Country_Name')
    writer.writerow(header)

    # Process each row
    for row in reader:
        country_code = int(row[1])  # The Country_Code is in the second column
        country_name = country_code_to_name.get(country_code, 'Unknown')
        row.insert(1, country_name)
        writer.writerow(row)

print(f"New CSV file '{output_file}' has been created with country names.")
